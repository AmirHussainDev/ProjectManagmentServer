...
export class InventoryPurchaseController {
  constructor(
    private readonly inventoryPurcahseService: InventoryPurchaseService,
  ) {}
  ...
  getPurchaseRequests(
    ...
    return this.inventoryPurcahseService.getPurchaseRequestsByState(
      parseInt(orgId),
      parseInt(subOrgId),
      parseInt(state),
    );
  ...
  getSaleRequestsByFilter(
    ...
    return this.inventoryPurcahseService.getSalesRequests(
      parseInt(orgId),
      parseInt(subOrgId),
      state,
    );
  ...
  async getInventoryItem(
    ...
    return this.inventoryPurcahseService.getInventory(
      parseInt(orgId),
      parseInt(subOrgId),
    );
  }
  ...
  async getInventoryItemDetails(
    ...
    return this.inventoryPurcahseService.getInventoryItemDetails(
      parseInt(orgId),
      parseInt(subOrgId),
      name,
    );
